...
\begin{figure}[ht]
\figcaption{fig:process-state-unix}{Etats et transitions d'un processus Unix}
\begin{center}
...
\begin{figure}[ht]
\figcaption{fig:process-space}{Espace d'adressage d'un processus}
\begin{center}
...
\begin{figure}[!ht]
\figcaption{fig:process-space-multi}{Espace d'adressage d'un processus multi-thread}
\begin{center}
...
\begin{figure}[ht]
\figcaption{fig:thread-execution}{Flot d'exécution d'un processus multi-thread}
\begin{center}
...
\begin{figure}[ht]
\figcaption{fig:thread-execution-single}{Flot d'exécution d'un processus multi-thread sur un processeur simple coeur}
\begin{center}
...
\begin{figure}[ht]
\figcaption{fig:mandelbrot}{Courbe de Mandelbrot}
\begin{center}
...
\begin{figure}[ht]
\figcaption{fig:model-boss-worker}{Modèle délégation}
\begin{center}
...
\begin{figure}[ht]
\figcaption{fig:model-peer}{Modèle pair}
\begin{center}
...
\begin{figure}[ht]
\figcaption{fig:model-pipeline}{Modèle pipeline}
\begin{center}
