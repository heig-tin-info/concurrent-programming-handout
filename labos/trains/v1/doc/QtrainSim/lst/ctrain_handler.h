 ...
 *                    08.9.2011 (Jérémie Ecoffey) Adaptation au nouveau simulateur.
 */
 ...
 *            "mettre_vitesse_loco". Son comportement dépend de l'option
 ...
 *            Les phares sont toujours allumés, et indiquent le sens de la loco.
 */
 ...
 * Remarque : Dans le simulateur, le comportement dépend de l'option "Inertie" dans le menu ad hoc.
 */
 ...
 * Remarque : cette méthode n'est pas utilisée dans le simulateur.
 ...
 * Le numero et la vitesse de la loco sont définies, et elle est ensuite placee
