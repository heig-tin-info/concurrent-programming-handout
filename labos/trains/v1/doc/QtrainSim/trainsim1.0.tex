...
\attention Attention, sous \noun{QtCreator} il faut désactiver l'option "Shadow build". Ceci ce fait via l'onglet "Projects", dans la barre de gauche, puis en sélectionnant les "Build settings". Il y est possible de désactiver cette option. Ceci n'a pas lieu d'être en ligne de commande.
...
objets en C++ (le simulateur lui-même est en C++), et même d'utiliser
